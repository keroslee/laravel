...
<div id="fullpage" class="allmian">
  ...
  <div class="section" style="background-image: url({{$homes->get(8)->path}});">
    <div class="pp_cont box_cont1">
      ...
      <div class="dn_lding"><a data-menuanchor="page10" id="totop" href="#page10"><img src="/images/down_landing.png" /></a></div>
    </div>
  </div>
  <div class="section" style="background-image: url({{$homes->get(9)->path}});">
    <div class="pp_cont box_cont2">
      ...
      <div class="dn_lding"><a data-menuanchor="page11" id="totop" href="#page11"><img src="/images/down_landing.png" /></a></div>
    </div>
  </div>
  <div class="section" style="background-image: url({{$homes->get(10)->path}});">
    <div class="pp_cont box_cont1">
      ...
      <div class="dn_lding"><a data-menuanchor="page12" id="totop" href="#page12"><img src="/images/down_landing.png" /></a></div>
    </div>
  </div>
  <div class="section" style="background-image: url({{$homes->get(11)->path}});">
    <div class="pp_cont box_cont2">
      ...
      <div class="dn_lding"><a data-menuanchor="page13" id="totop" href="#page13"><img src="/images/down_landing.png" /></a></div>
    </div>
  </div>
</div>
