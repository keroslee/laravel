                    ...
                    <tr class="{{$colors[$idx%count($colors)]}}" id="row{{$result->tid}}">
                        ...
                        <td style="padding:0 8px;">
                            <button type="button" class="bj"
                                    ...
                                    data-spno="{{$result->spno}}"
                                    data-spbm="{{$result->spbm}}"
                                    data-spsj="{{$result->spsj}}"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modalEditTitle">编辑审批信息</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label">审批文号</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="spno" placeholder="审批文号">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label">审批部门</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="spbm" placeholder="审批部门">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label">审批时间</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="spsj" placeholder="审批时间">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label">审批内容</label>
                                    <div class="col-sm-10">
            ...
            <div class="modal fade" tabindex="-1" role="dialog" id="modalConfirm">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title">确认要删除这些审批吗？</h4>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-del" data-dismiss="modal">取消</button>
...
@section('script')
    <script>
        ...
        $('#modalEdit').on('show.bs.modal', function (event) {
            ...
            var spno = button.data('spno');
            var spbm = button.data('spbm');
            var spsj = button.data('spsj');
            var content = button.data('content');
            var mark = button.data('mark');

            modal.find('.modal-body #tid').val(tid);
            modal.find('.modal-body #companyTid').val(companyTid);
            modal.find('.modal-body #spno').val(spno);
            modal.find('.modal-body #spbm').val(spbm);
            modal.find('.modal-body #spsj').val(spsj);
        ...
        $('#save').click(function (env) {
            ...
            var data = {
                ...
                spno: modal.find('.modal-body #spno').val(),
                spbm: modal.find('.modal-body #spbm').val(),
                spsj: modal.find('.modal-body #spsj').val(),
        ...
        function updateRow(data) {
            var keys = ['tid', 'companytid', 'spno', 'spbm', 'spsj', 'content', 'mark'];
            ...
            if (row.length) {
                ...
                cells[3].innerHTML = data['spno'];
                cells[4].innerHTML = data['spbm'];
                cells[5].innerHTML = data['spsj'];
                ...
                cell = row.insertCell();
                cell.innerHTML = data['spno']
                cell = row.insertCell();
                cell.innerHTML = data['spbm'];
                cell = row.insertCell();
                cell.innerHTML = data['spsj'];
                cell = row.insertCell();
